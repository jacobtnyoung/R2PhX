...
The data are reported as UCR crime classifications and have geographic information (block address, zip) as well as the date and time of the incident. As of `r format(Sys.time(), '%B, %Y')`, there were `r n.cases` crime incidents with complete data from 11/2015 to within a week of the current date.   
...
This view is useful, but it might help if we break it down by year and month. 
