...
url <- "https://www.phoenixopendata.com/dataset/754b1156-a48f-4d1b-b17a-53bd96d5b2be/resource/24fe89fb-9d4f-4fba-8b40-9330a5f7d9e7/download/ois.csv"
...
The dataset contains information about:  
  ...
  + The *officer(s)* involved, denoted by the `PO_` prefix (e.g. `PO_RACE`, `PO_ETHNICITY`)  
...
date.vec <- strptime( shooting.data$DATE, format="%m/%d/%y" )
...
f.nf.shootings.by.year <- 
   shooting.data %>% 
   select( YEAR, FATALITY_FLG ) %>%   
   group_by( YEAR, FATALITY_FLG ) %>% 
   summarize( counts = n() )
