...
<br>
The plot shows a fairly stable daily count of crimes. *But*, a marked **decline** towards the end of 2019. Since the end of 2019 through the beginning of 2021, crime incidents have been trending down in Phoenix. Importantly, for 2022, there was an overall decrease in the daily counts of crime incidents.   
...
The plot showing the monthly rates by year helps us visualize the data better. There are a few important patterns we can take from the plot:  
  ...
  + Second, relative to past years, more recent criminal incidents tend to be lower. For example, 2021 and 2022 both show a generally lower rate of crime incidents relative to 2017-2020. 
